...
public class AiAdminClientAdvisorController {
    ...
    public ResponseEntity<AiClientAdvisor> queryClientAdvisorById(@RequestParam Long id) {
        try {
    ...
    public ResponseEntity<Boolean> deleteClientAdvisor(@RequestParam Long id) {
        try {
