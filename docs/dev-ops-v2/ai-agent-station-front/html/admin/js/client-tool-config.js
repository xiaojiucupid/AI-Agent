...
const ClientToolConfigManager = {
    ...
    loadToolConfigList: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/client/tool/config/queryClientToolConfigList'),
            type: 'POST',
    ...
    editToolConfig: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/tool/config/queryClientToolConfigById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    saveToolConfig: function() {
        ...
        if (id) {
            ...
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/tool/config/updateClientToolConfig'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
            ...
            // 新增模式
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/tool/config/addClientToolConfig'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
    ...
    deleteToolConfig: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/tool/config/deleteClientToolConfig?id=${this.deleteToolConfigId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    alert('删除成功');
