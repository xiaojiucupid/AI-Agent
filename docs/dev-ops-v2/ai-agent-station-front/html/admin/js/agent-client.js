...
const AgentClientManager = {
    ...
    loadAllAgentClient: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/agent/client/queryAgentClientList'),
            type: 'POST',
    ...
    loadAgentClientByAgentId: function(agentId) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/client/queryAgentClientByAgentId?agentId=${agentId}`),
            type: 'GET',
            success: (res) => {
                this.renderAgentClientList(res);
                // 特定查询不需要分页
    ...
    loadAgentClientByClientId: function(clientId) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/client/queryAgentClientByClientId?clientId=${clientId}`),
            type: 'GET',
            success: (res) => {
                this.renderAgentClientList(res);
                // 特定查询不需要分页
    ...
    editAgentClient: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/client/queryAgentClientById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    addAgentClient: function(agentClient) {
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/agent/client/addAgentClient'),
            type: 'POST',
            contentType: 'application/json',
    ...
    updateAgentClient: function(agentClient) {
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/agent/client/updateAgentClient'),
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(agentClient),
            success: (res) => {
    ...
    deleteAgentClient: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/client/deleteAgentClient?id=${this.deleteAgentClientId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    alert('删除成功');
