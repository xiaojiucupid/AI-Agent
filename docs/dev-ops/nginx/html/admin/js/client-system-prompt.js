...
const SystemPromptManager = {
    ...
    loadSystemPromptList: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/client/system/prompt/querySystemPromptList'),
            type: 'POST',
    ...
    editSystemPrompt: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/system/prompt/querySystemPromptById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    saveSystemPrompt: function() {
        ...
        if (id) {
            ...
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/system/prompt/updateSystemPrompt'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
            ...
            // 新增
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/system/prompt/addSystemPrompt'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
    ...
    deleteSystemPrompt: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/system/prompt/deleteSystemPrompt?id=${this.deleteSystemPromptId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    // 关闭模态框
