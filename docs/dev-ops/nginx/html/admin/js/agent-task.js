...
const TaskScheduleManager = {
    ...
    loadTaskScheduleList: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/agent/task/queryTaskScheduleList'),
            type: 'POST',
    ...
    editTaskSchedule: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/task/queryTaskScheduleById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    saveTaskSchedule: function() {
        ...
        if (id) {
            ...
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/agent/task/updateTaskSchedule'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
            ...
            // 新增
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/agent/task/addTaskSchedule'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
    ...
    deleteTaskSchedule: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/agent/task/deleteTaskSchedule?id=${this.deleteTaskScheduleId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    alert('删除成功');
