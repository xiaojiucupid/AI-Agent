...
const ClientAdvisorManager = {
    ...
    loadClientAdvisorList: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/client/advisor/queryClientAdvisorList'),
            type: 'POST',
    ...
    editClientAdvisor: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/advisor/queryClientAdvisorById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    saveClientAdvisor: function() {
        ...
        if (id) {
            ...
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/advisor/advisor/updateClientAdvisor'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
            ...
            // 新增
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/advisor/addClientAdvisor'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
    ...
    deleteClientAdvisor: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/advisor/deleteClientAdvisor?id=${this.deleteClientAdvisorId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    alert('删除成功');
