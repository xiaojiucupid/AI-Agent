...
const ClientAdvisorConfigManager = {
    ...
    loadAdvisorConfigList: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl('/ai/admin/client/advisor/config/queryClientAdvisorConfigList'),
            type: 'POST',
    ...
    editAdvisorConfig: function(id) {
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/advisor/config/queryClientAdvisorConfigById?id=${id}`),
            type: 'GET',
            success: (res) => {
    ...
    saveAdvisorConfig: function() {
        ...
        if (id) {
            ...
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/advisor/config/updateClientAdvisorConfig'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
            ...
            // 新增模式
            $.ajax({
                url: ApiConfig.getApiUrl('/ai/admin/client/advisor/config/addClientAdvisorConfig'),
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(params),
                success: (res) => {
    ...
    deleteAdvisorConfig: function() {
        ...
        $.ajax({
            url: ApiConfig.getApiUrl(`/ai/admin/client/advisor/config/deleteClientAdvisorConfig?id=${this.deleteAdvisorConfigId}`),
            type: 'GET',
            success: (res) => {
                if (res) {
                    alert('删除成功');
